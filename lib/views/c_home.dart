...
class HomeTile extends StatelessWidget {
  const HomeTile({super.key, required this.text, required this.icon, required this.route});
    ...
    return FilledButton(
      ...
      style: ButtonStyle(
        ...
        shape: MaterialStatePropertyAll(RoundedRectangleBorder(
          side: BorderSide(color: Theme.of(context).colorScheme.onPrimaryContainer, width: 2),
        ...
        minimumSize: MaterialStatePropertyAll(Size.fromHeight(MediaQuery.sizeOf(context).height * 0.1565)),
      ),
      child: Row(
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: RichText(text: const TextSpan(
          ...
          children: <TextSpan>[
            TextSpan(text: 'Username', style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold))
          ],),
        ...
        child: Container(
          ...
          child: Padding(
            ...
            child: SingleChildScrollView(
              child: (!showTracking) ? const Column(
                children: [
                  SizedBox(height: 36,),
                  HomeTile(text: 'Send', icon: Icons.send_rounded, route: '/getQuote',),
                  SizedBox(height: 36,),
                  HomeTile(text: 'Get Quote', icon: Icons.request_quote_rounded, route: '/getQuote',),
                  SizedBox(height: 36,),
                  HomeTile(text: 'Watchlist', icon: Icons.watch_later_rounded, route: '/watchlist',),
                  SizedBox(height: 36,),
                ]
              )
              :
              Column(
                children: [
                  ...
                  (showTracking) ?
                  const ShipmentDetails(awb: '24012001', date: '9/5/24', status: 'Sleeping', watch: true,)
