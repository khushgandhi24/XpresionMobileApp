...
class PInScanModel {
  ...
  factory PInScanModel.fromJson(Map<String, dynamic> json) => PInScanModel(
              ...
              child: Container(
                ...
                child: Column(
                  children: [
                    ...
                    Row(
                      children: [
                        GestureDetector(onTap: () => value.fetchLocation(), child: const Icon(Symbols.location_pin)),
                      ...
                      child: Padding(
                        ...
                        if (value.query.isNotEmpty) {
                          ...
                          Future.delayed(const Duration(milliseconds: 1000), () {
                            ...
                            SnackBar(
                              content: (value.result.isNotEmpty ? Text(value.result): count > 1 ? Text('$count AWBs added') : Text('$count AWB added')),
                              showCloseIcon: true,
